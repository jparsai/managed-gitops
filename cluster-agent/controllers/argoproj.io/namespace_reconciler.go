...
func runNamespaceReconcile(ctx context.Context, dbQueries db.DatabaseQueries, client client.Client, log logr.Logger) {
	...
	processedApplicationIds := make(map[string]bool)
...
func deleteOrphanedApplications(argoApplications []appv1.Application, processedApplicationIds map[string]bool, ctx context.Context, client client.Client, log logr.Logger) []appv1.Application {
