...
import (
	...
	appstudioredhatcomv1alpha1 "github.com/redhat-appstudio/managed-gitops/appstudio-shared/apis/appstudio.redhat.com/v1alpha1"
...
func main() {
	...
	if err = (&appstudioredhatcomv1alpha1.ApplicationSnapshotEnvironmentBinding{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "ApplicationSnapshotEnvironmentBinding")
		os.Exit(1)
	}
	if err = (&appstudioredhatcomv1alpha1.ApplicationSnapshot{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "ApplicationSnapshot")
		os.Exit(1)
	}
	if err = (&appstudioredhatcomv1alpha1.ApplicationPromotionRun{}).SetupWebhookWithManager(mgr); err != nil {
